...
st.markdown(
    ...
    <style>
        ...
        /* Ocultar insignia, barra flotante, iframes, botón Manage app y estado de Streamlit */
        .viewerBadge, div[class*="viewerBadge"], [data-testid="stStatusWidget"], iframe[title="streamlit-badge"], [data-testid="manage-app-button"], div[class*="styles_viewerBadge"], button[kind="header"] {
        ...
        /* Ocultar contenedores flotantes inferiores derechos de Streamlit Cloud */
        div:has(> button[kind="secondary"][data-testid="manage-app-button"]),
    ...
    <!-- Script JS agresivo para eliminar el botón Manage app y badges -->
    <script>
        function eliminarBadgesStreamlit() {
            ...
            for (var i = 0; i < allElements.length; i++) {
                ...
                if (el && el.innerText) {
                    ...
                    if (texto.indexOf('Manage app') !== -1 || texto.indexOf('Hosted with Streamlit') !== -1) {
                        var container = el.closest('div[style*="position"], button, div[data-testid="stStatusWidget"]') || el.parentElement;
                        if (container) {
            ...
            if (badge1) { 
                ...
                if (badge1.parentElement) { badge1.parentElement.style.display = 'none'; }
            }
            var badge2 = document.querySelector('[data-testid="stStatusWidget"]');
            if (badge2) { badge2.style.display = 'none'; }
        }
        setInterval(eliminarBadgesStreamlit, 150);
    </script>
""",
